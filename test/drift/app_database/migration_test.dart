...
void main() {
  ...
  test(
    'migration from v4 to v5 backfills serving and preserves data',
    () async {
      final oldFoodsData = <v4.FoodsData>[
        const v4.FoodsData(
          id: 1,
          name: 'Apple',
          caloriesPerServing: 100,
      ...
      final oldMealEntriesData = <v4.MealEntriesData>[
        const v4.MealEntriesData(
          id: 1,
          foodId: 1,
          foodNameSnapshot: 'Apple',
      ...
      final expectedFoodsData = <v5.FoodsData>[
        const v5.FoodsData(
          id: 1,
          name: 'Apple',
          caloriesPerServing: 100,
      ...
      final expectedMealEntriesData = <v5.MealEntriesData>[
        const v5.MealEntriesData(
          id: 1,
          foodId: 1,
          foodNameSnapshot: 'Apple',
          caloriesPerServingSnapshot: 100,
  ...
  test('migration from v5 to v6 renames serving without losing data', () async {
    final oldFoodsData = <v5.FoodsData>[
      const v5.FoodsData(
        id: 1,
        name: 'Apple',
        caloriesPerServing: 100,
    ...
    final oldMealEntriesData = <v5.MealEntriesData>[
      const v5.MealEntriesData(
        id: 1,
        foodId: 1,
        foodNameSnapshot: 'Apple',
    ...
    final expectedFoodsData = <v6.FoodsData>[
      const v6.FoodsData(
        id: 1,
        name: 'Apple',
        caloriesPerServing: 100,
    ...
    final expectedMealEntriesData = <v6.MealEntriesData>[
      const v6.MealEntriesData(
        id: 1,
        foodId: 1,
        foodNameSnapshot: 'Apple',
        caloriesPerServingSnapshot: 100,
